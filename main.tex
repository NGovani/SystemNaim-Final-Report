...
\begin{document}
    ...
    \input{01_project_intro/index.tex}
    \input{02_background/index.tex}
    \input{03_design/index.tex}
    \input{04_implementation/index.tex}
    \input{05_evaluation/index.tex}
    \input{06_future_work/index.tex}
    \input{07_conclusion/index.tex}
    % add more sections here!

    \begin{appendices}
        \input{08_code_listings/index.tex}
    \end{appendices}
